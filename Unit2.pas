...
if (edt1.Text= '')or (edt2.Text ='')or(edt3.Text= '')or (edt4.Text ='')or (edt5.Text ='')or (edt6.Text ='')or (edt7.Text ='')or (cbb2.Text ='')or (cbb1.Text ='') then
  ...
  begin
    ...
    zqry1.SQL.Clear;
    zqry1.SQL.Add('UPDATE ortu SET nik="'+edt1.Text+'",nama_ortu="'+edt2.Text+'",pendidikan="'+edt3.Text+'",pekerjaan="'+edt4.Text+'",telp="'+edt5.Text+'",alamat="'+edt6.Text+'",jenis_kelamin="'+cbb1.Text+'",agama="'+edt7.Text+'",status="'+cbb2.Text+'" where id="'+id+'"');
    zqry1.ExecSQL;
