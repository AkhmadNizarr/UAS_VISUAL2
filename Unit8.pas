...
begin
  ...
  begin
    ...
    zqry1.SQL.Clear;
    zqry1.SQL.Add('UPDATE wali SET nik="'+edt1.Text+'",nama_wali="'+edt2.Text+'",jenis_kelamin="'+cbb1.Text+'",pendidikan="'+edt3.Text+'",telp="'+edt4.Text+'",alamat="'+edt5.Text+'",mata_pelajaran="'+edt6.Text+'",status="'+cbb2.Text+'" where id="'+id+'"');
    zqry1.ExecSQL;
